<template>
  <Layout :back="true" :nav="false">
    ...
    <Tags :tag-list="tagList" :selected.sync="selectedTag" :single="true"/>
...
<script lang="ts">
  ...
  export default class EditLabel extends Vue {
    ...
    tagList: Tag[] = [
      {id: 1, type: {text: '支出', value: '-'}, text: '交通', name: 'bus'},
      {id: 2, type: {text: '支出', value: '-'}, text: '水果', name: 'fruit'},
      {id: 3, type: {text: '支出', value: '-'}, text: '医院', name: 'health'}
    ];
